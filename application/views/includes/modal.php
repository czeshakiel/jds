...
<div class="modal fade" id="CancelCheckIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" action="<?=base_url('cancel_checkin');?>" method="POST"> 
                <input type="hidden" name="refno" id="cancel_checkin_refno">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
